...
# Load in files
# all_families = visual.ResultsLoader().load_file_from_id(49)
# all_families_dnotua = visual.ResultsLoader().load_file_from_id(50)
cbase = visual.ResultsLoader().load_file_from_id(51)
c1 = visual.ResultsLoader().load_file_from_id(52)
# c2 = visual.ResultsLoader().load_file_from_id(53)
dowgin_solo = visual.ResultsLoader().load_file_from_id(54)
dnotua_solo = visual.ResultsLoader().load_file_from_id(55)
kuguo_solo = visual.ResultsLoader().load_file_from_id(56)
airpush_solo = visual.ResultsLoader().load_file_from_id(57)
revmob_solo = visual.ResultsLoader().load_file_from_id(58)
